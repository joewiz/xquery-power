...
## These open source projects run on XQuery-powered servers

- [XQuery Content Management Library (XCM)](https://github.com/ssire/xquery-cm-lib) is a project to develop content management applications with features such as workflow management, semi-structured content editing, formular generation and e-mail output engine. It works with eXist-DB. The [case tracker pilote](https://github.com/ssire/case-tracker-pilote) project is a demonstration application built with the XCM library which can be used as a sacffold to create new applications.
